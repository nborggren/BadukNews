...
딥젠고 프로젝트가 추진된 건 이세돌 vs 알파고 딥마인드챌리지매치가 세계적인 화제를 뿌리며 끝난 3월15일로부터 이틀 뒤인 17일이다. 발빠른 시도였다. 
 알파고를 능가하는 세계최고 수준의 바둑 프로그램을 만들어 인공지능기술 향상과 바둑계 발전에 공헌하겠다는 게 목적이었다. 알파고는 심층신경망을 사용해 기계학습을 하는 방식인 딥러닝을 적용했다. 개발팀은 젠에도 딥러닝을 거치게 하고자 했는데 그러자면 개발환경이 뒷받침돼야 했다. 바둑프로그램 젠(zen)의 개발자 오시마 요지(尾島陽児)ㆍ가토 히데키(加藤英樹) 씨 두 사람이 개발의 전면에 나서고 동경대교수팀과 IT기업 드왕고社 엔지니어들로 구성된 팀이 지원을 아끼지 않았다. 반년이 흐른 9월 시점에선 기력 지표인 고레이팅(Go Ratings) 3,000을 기록, 2015년 10월의 알파고 수준의 기력을 구현해 냈으며 제2회 전왕전 직전까지 개발을 지속했다. 전왕전에 사용된 딥젠고는 버전13이었다. 
