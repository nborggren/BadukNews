...
기보 없이 스스로 바둑 실력 키워 … 
[언론보도] 
  2017-01-26 오전 11:31   [프린트｜스크랩]
▲ 데미스 허사비스 구글 딥마인드 최고경영자(CEO)[중앙포토]
[출처: 중앙일보] 1월 26일 정아람 기자가 쓴 [기보 없이 스스로 바둑 실력 키워 … 더 똑똑해진 ‘알파고 2.0’ 나왔다]을 옮겼습니다.  ○● [중앙일보] 기사원문보기  ☜ 클릭
인간 기보로는 큰 도약 어려워져
구글, 새 접근법으로 돌파구 모색
구글 딥마인드가 개발한 인공지능(AI) 바둑 프로그램 ‘알파고’의 두 번째 버전이 나왔다. 새로운 알파고는 인간의 기보 없이 강화학습만으로 스스로 성장해 한계를 찾는다는 점이 특징이다.
데미스 허사비스 구글 딥마인드 최고경영자(CEO)는 지난 17일 독일 뮌헨에서 열린 ‘2017 디지털·라이프·디자인(DLD) 콘퍼런스’에서 “알파고가 새로운 한계를 시험하고 있다”며 “두 번째 단계로 ‘알파고’에 기보를 입력하지 않고 처음부터 자체적인 강화 학습만으로 기력을 향상시키는 시험을 하고 있다”고 밝혔다. 허사비스는 이 밖에 도전 과제로 “알파고의 수법을 이해하고 강화 학습의 한계를 찾아 바둑에서 신의 경지에 도달하는 것”이라고 밝혔다.
이는 알파고의 수준을 한층 더 업그레이드하기 위한 고안으로 풀이된다. 이제까지 구글 딥마인드는 알파고에 10만 개의 기보를 입력해 강화 학습을 반복하는 방식으로 기력을 향상시켜 왔다. 감동근 아주대 전자공학과 교수는 “기보 입력으로는 알파고가 인간 수준을 크게 뛰어넘기 얻기 어렵다고 판단, 새 접근법으로 돌파구를 찾으려는 듯하다”며 “자체 강화 학습만으로 훨씬 더 수준 높은 AI 바둑 프로그램이 나올지, 아니면 기존의 한계에 수렴할지 등은 지켜봐야 한다”고 말했다.
